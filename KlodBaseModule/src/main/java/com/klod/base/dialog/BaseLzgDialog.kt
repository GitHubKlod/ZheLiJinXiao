...
open class BaseLzgDialog constructor(context: Context, @StyleRes themeResId: Int = R.style.BaseDialogTheme) :
    ...
    private val listeners: ListenersWrapper<BaseLzgDialog> = ListenersWrapper(this)
    ...
    open class Builder<B : Builder<B>> constructor(private val context: Context) :
        ...
        /** Dialog 对象 */
        private var dialog: BaseLzgDialog? = null
         ...
         */
        protected open fun createDialog(context: Context, @StyleRes themeId: Int): BaseLzgDialog {
            return BaseLzgDialog(context, themeId)
        }
         ...
         * 获取当前 Dialog 对象
         */
        open fun getDialog(): BaseLzgDialog? {
            return dialog
        }
    }
     ...
     * Dialog 生命周期绑定
     */
    private class DialogLifecycle(private var activity: Activity?, private var dialog: BaseLzgDialog?) :
        ActivityLifecycleCallbacks, OnShowListener, OnDismissListener {

        companion object {

            fun with(activity: Activity, dialog: BaseLzgDialog?) {
        ...
        override fun onShow(dialog: BaseLzgDialog?) {
            this.dialog = dialog
            registerActivityLifecycleCallbacks()
        }

        override fun onDismiss(dialog: BaseLzgDialog?) {
            this.dialog = null
            unregisterActivityLifecycleCallbacks()
        }
    ...
    private class ViewClickWrapper constructor(
        private val dialog: BaseLzgDialog?,
    ...
    private class CancelListenerWrapper constructor(referent: DialogInterface.OnCancelListener?) :
        ...
        override fun onCancel(dialog: BaseLzgDialog?) {
            // 在横竖屏切换后监听对象会为空
            get()?.onCancel(dialog)
        }
    }
    ...
    private class KeyListenerWrapper constructor(private val listener: OnKeyListener?) : DialogInterface.OnKeyListener {
        ...
        override fun onKey(dialog: DialogInterface?, keyCode: Int, event: KeyEvent?): Boolean {
            // 在横竖屏切换后监听对象会为空
            if (listener == null || dialog !is BaseLzgDialog) {
                return false
            }
    ...
    interface OnClickListener<V : View> {
         ...
         * 点击事件触发了
         */
        fun onClick(dialog: BaseLzgDialog?, view: V)
    }
    ...
    interface OnCreateListener {
         ...
         * Dialog 创建了
         */
        fun onCreate(dialog: BaseLzgDialog?)
    }
    ...
    interface OnShowListener {
         ...
         * Dialog 显示了
         */
        fun onShow(dialog: BaseLzgDialog?)
    }
    ...
    interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        fun onCancel(dialog: BaseLzgDialog?)
    }
    ...
    interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        fun onDismiss(dialog: BaseLzgDialog?)
    }
    ...
    interface OnKeyListener {
         ...
         * 触发了按键
         */
        fun onKey(dialog: BaseLzgDialog?, event: KeyEvent?): Boolean
    }
}