...
public class MiddlewareWebViewClient extends MiddlewareWebClientBase {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        Log.e("Info", "MiddlewareWebViewClient -- >  shouldOverrideUrlLoading:" + request.getUrl().toString() + "  c:" + (count++));
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        Log.e("Info", "MiddlewareWebViewClient -- >  shouldOverrideUrlLoading:" + url + "  c:" + (count++));
