package com.zhili.zljx.ui.home.message
...
import com.zhili.zljx.client.MiddlewareChromeClient
import com.zhili.zljx.client.MiddlewareWebViewClient
import com.zhili.zljx.common.Contacts
import com.zhili.zljx.databinding.FragmentMessageBinding
 ...
 *2023/3/29 16:36
 */
class MessageFragment : BaseMvvmFragment<MessageFragmentVm, FragmentMessageBinding>() {
    ...
    private fun loadWebView() {
        ...
        mAgentWeb =  AgentWeb.with(this)
            .setAgentWebParent(mViewBind.messageAgentWeb, FrameLayout.LayoutParams(-1, -1))
//                        .closeIndicator()
...
//            .useMiddlewareWebClient(middlewareWebViewClient)
            .createAgentWeb()
            .ready()
            .go(Contacts.HomeMessageUrl)
...
//    }
    ...
    private var lastUrl = ""
    private var lastFinishUrl = ""

    private val mWebViewClient: WebViewClient = object : WebViewClient() {


        override fun onPageFinished(view: WebView?, url: String?) {
            "信息WebView地址 Finish  = $url".logE()
            lastFinishUrl = url?:""
...
//            val url = request?.url.toString()
            //查看加载的地址
            "信息WebView地址 onPageStarted  = $url".logE()
            if(url.isNotEmpty()){
                //检测跳转
                if(mContext.checkUrl(url)){
                    view?.stopLoading()
                }
            }
        }
...
//
//private val middlewareWebViewClient = object :MiddlewareWebClientBase() {
//
...
//        //拦截操作
//        val url = request?.url.toString()
//        "信息WebView地址11111  = $url".logE()
//
//        return super.shouldOverrideUrlLoading(view, request)
//    }
//
//}
//private val middlewareWebChrome = object : MiddlewareWebChromeBase() {
//
//    override fun onReceivedTitle(view: WebView?, title: String?) {
//        "信息WebView地址11111TTT  = $title".logE()
//
