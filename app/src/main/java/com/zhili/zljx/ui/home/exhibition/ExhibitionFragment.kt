package com.zhili.zljx.ui.home.exhibition
...
import com.zhili.zljx.databinding.FragmentExhibitionBinding
 ...
 *2023/3/29 16:30
 */
class ExhibitionFragment : BaseMvvmFragment<ExhibitionFragmentVm, FragmentExhibitionBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mAgentWeb =  AgentWeb.with(this)
            .setAgentWebParent(mViewBind.exhibitionAgentWeb, FrameLayout.LayoutParams(-1, -1))
            //            .useDefaultIndicator()
...
//
    ...
    private val mWebViewClient: WebViewClient = object : WebViewClient() {
        ...
        override fun onPageFinished(view: WebView?, url: String?) {
            "展会WebView地址 onPageFinished = $url".logE()

            url?.checkConstraintSet()
//            if(url!=Contacts.HomeExhibitionUrl){
