...
import com.zhili.zljx.databinding.ItemCityHistoryPickerBinding
 ...
 *2023/4/22 10:31
 */
class LocationCityHistoryAdapter : BaseQuickAdapter<LocationDataInfo, LocationCityHistoryAdapter.VH>() {

    // 自定义ViewHolder类
    class VH(
        parent: ViewGroup,
        val binding: ItemCityHistoryPickerBinding = ItemCityHistoryPickerBinding.inflate(
