...
import com.klod.base.action.AnimAction
import com.klod.base.dialog.BaseLzgDialog
import com.klod.base.ext.util.logE
import com.zhili.zljx.R
import com.zhili.zljx.app.MyApplication
import com.zhili.zljx.utils.aop.CheckNet
import com.zhili.zljx.utils.aop.Permissions
import com.zhili.zljx.utils.aop.SingleClick
import java.io.File
...
class UpdateDialog {
    ...
    class Builder(context: Context) : BaseLzgDialog.Builder<Builder>(context) {
...
//                Aria.download(getContext()).unRegister()
        ...
        private val notificationBuilder by lazy {
            NotificationCompat.Builder(getContext(), channelId)
                ...
                // 设置通知小图标
                .setSmallIcon(R.mipmap.icon_zljx)
                // 设置通知大图标
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.icon_zljx))
                // 设置通知静音
        ...
        private fun downloadApk() {
            ...
            // 创建要下载的文件对象
            apkFile = File(
                getContext().filesDir.absolutePath + "/apk/",
                getString(R.string.app_name) + "_v" + nameView?.text.toString() + ".apk"
            )

            "下载地址: = $downloadUrl \n 到 = ${apkFile?.absolutePath}".logE()

//            Aria.download(this)
//                .load(downloadUrl)
//                .setFilePath(apkFile?.absolutePath)
//                .create()
        ...
        private fun getInstallIntent(): Intent {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(
                    getContext(),
                    MyApplication.application.packageName + ".fileprovider",
                    apkFile!!
                )
...
//
//                var progress = task.percent	//任务进度百分比
