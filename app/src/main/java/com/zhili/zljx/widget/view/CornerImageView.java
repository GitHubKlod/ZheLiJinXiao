...
public class CornerImageView extends AppCompatImageView {
    ...
    public static final int CENTERCROP = 4;
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CornerImageView);
        //  半径
        radius = ta.getDimension(R.styleable.CornerImageView_radiusYL, 0);
        topLeftRadius = ta.getDimension(R.styleable.CornerImageView_topLeftRadiusYL, 0);
        topRightRadius = ta.getDimension(R.styleable.CornerImageView_topRightRadiusYL, 0);
        bottomLeftRadius = ta.getDimension(R.styleable.CornerImageView_bottomLeftRadiusYL, 0);
        bottomRightRadius = ta.getDimension(R.styleable.CornerImageView_bottomRightRadiusYL, 0);
        //  展示类型
        styleType = ta.getInt(R.styleable.CornerImageView_scaleTypeYL, TOP);

        //  描边
        borderWidth = ta.getDimension(R.styleable.CornerImageView_borderWidthYL, 0);
        borderSpace = ta.getDimension(R.styleable.CornerImageView_borderSpaceYL, 0);
        borderColor = ta.getColor(R.styleable.CornerImageView_borderColorYL, Color.WHITE);

        //  不常用属性
        topLeftRadius_x = ta.getDimension(R.styleable.CornerImageView_topLeftRadius_xYL, 0);
        topLeftRadius_y = ta.getDimension(R.styleable.CornerImageView_topLeftRadius_yYL, 0);
        topRightRadius_x = ta.getDimension(R.styleable.CornerImageView_topRightRadius_xYL, 0);
        topRightRadius_y = ta.getDimension(R.styleable.CornerImageView_topRightRadius_yYL, 0);
        bottomLeftRadius_x = ta.getDimension(R.styleable.CornerImageView_bottomLeftRadius_xYL, 0);
        bottomLeftRadius_y = ta.getDimension(R.styleable.CornerImageView_bottomLeftRadius_yYL, 0);
        bottomRightRadius_x = ta.getDimension(R.styleable.CornerImageView_bottomRightRadius_xYL, 0);
        bottomRightRadius_y = ta.getDimension(R.styleable.CornerImageView_bottomRightRadius_yYL, 0);
